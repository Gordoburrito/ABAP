"""
Main entry point for Ford data processing.
...
class FordPipeline:
    """Main pipeline orchestrator for Ford data processing."""
    
    def __init__(self, config_file: Optional[str] = None):
        """
        Initialize the Ford processing pipeline.
        
        Args:
            config_file: Optional path to configuration file
        """
        self.data_source = "Ford"
        ...
        self.single_processor = FordSingleProcessor(self.config)
        self.batch_processor = FordBatchProcessor(self.config)
    ...
    def run_full_pipeline(self, input_directory: str, output_directory: str) -> None:
        ...
        CUSTOMIZE THIS METHOD for your Ford needs!
        ...
        try:
            ...
            for json_file in json_files:
                try:
                    ...
                    # Customize this logic for your Ford!
    ...
    def _is_batch_file(self, file_path) -> bool:
        ...
        CUSTOMIZE THIS METHOD for your Ford file naming conventions!
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Ford Data Processing Pipeline')
    ...
    # Initialize pipeline
    pipeline = FordPipeline(args.config)
    ...
    try:
        ...
        print(f"Ford {args.command} processing completed successfully!")
        
    except Exception as e:
        print(f"Ford {args.command} processing failed: {e}")
        sys.exit(1)
